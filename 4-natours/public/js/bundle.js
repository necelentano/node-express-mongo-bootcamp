...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmVjZWxlbnRhbm8iLCJhIjoiY2tucTRheGVwMDJiZzJ3bzdrajdkbW03YyJ9.BKX3ykRqBy2IbLeF1RZVOw';
...
var stripe = Stripe('pk_test_51IsWJpJn5OeU2bB5TQ4qCq3EEfLBrYHV10hvGjFKmiEMti2l4BHfPOvN5tvuRf5BAZgKV3CbFSrgroTPHNB8MMHG00Wg9lwFMS');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var passwordCurrnet, password, passwordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.btn--save-password').textContent = 'Updating ...';
            passwordCurrnet = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            e.preventDefault();
            _context.next = 7;
            return (0, _updateSettings.updateSettings)({
              passwordCurrnet: passwordCurrnet,
              password: password,
